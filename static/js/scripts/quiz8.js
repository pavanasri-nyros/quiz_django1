...
var questions = [];
$.ajax({
  url: 'https://quizdjango2.herokuapp.com/api8/?format=json',
  type:'GET',
  async:true,
  dataType: "json",
...
function loadNextQuestion() {
  ...
  if (currentQuestion == totQuestions) {
    ...
    if(score == 0 || score < 40)
    {
        ...
        quiznameCont.innerHTML = "<span id='quiznames'>CSS Qui4 </span>";
        ...
        headingCont.innerHTML = '<h1>Result</h1>';
        quiznameCont.innerHTML = "<span id='quiznames'>CSS Quiz4</span>";
        timeCont.innerHTML = 'Time taken :' + 'Min:' + minutesLabel.textContent + ':'  + 'Sec:' + secondsLabel.textContent ;
